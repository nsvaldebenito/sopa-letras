package org.sitrack.sopaletras.repository.impl;

import java.util.List;
import java.util.UUID;

import org.sitrack.sopaletras.model.SoupEntity;
import org.sitrack.sopaletras.repository.CustomMongoRepository;
import org.springframework.data.mongodb.core.MongoOperations;
import org.springframework.data.mongodb.repository.query.MongoEntityInformation;
import org.springframework.data.mongodb.repository.support.SimpleMongoRepository;

public class CustomMongoRepositoryImpl<T extends SoupEntity> extends SimpleMongoRepository<T, UUID> implements CustomMongoRepository<T> {
